"""S4-A D4 — `evals/run_s4_a_d4_breakdown.py` 단위 테스트.
...
def _make_cell(
    *,
    ...
    """CellResult 생성 헬퍼."""
    from run_s4_a_d4_breakdown import CellResult
...
def _make_golden(
    *,
    ...
    """GoldenRow 생성 헬퍼."""
    from run_s4_a_d4_breakdown import GoldenRow
...
class GoldenV2SchemaTests(unittest.TestCase):
    ...
    def test_validate_golden_v2_schema_returns_expected_columns(self):
        from run_s4_a_d4_breakdown import validate_golden_v2_schema

        meta = validate_golden_v2_schema(self.golden_v2_path)
        # Phase 3 — cross_doc n=4→8 보강으로 +5 (157→162)
        self.assertEqual(meta["n_rows"], 162, "golden_v2 는 162 row (Phase 3 cross_doc 보강)")
        expected = {
            "id",
            "query",
            "query_type",
    ...
    def test_caption_dependent_18_true_144_false(self):
        """caption_dependent — true 18 / false 144 (Phase 3 cross_doc 5건 추가, caption=false)."""
        from run_s4_a_d4_breakdown import validate_golden_v2_schema

        meta = validate_golden_v2_schema(self.golden_v2_path)
        self.assertEqual(meta["caption_counts"].get("true", 0), 18)
        self.assertEqual(meta["caption_counts"].get("false", 0), 144)
    ...
    def test_qtype_9_categories_present(self):
        ...
        out_of_scope."""
        from run_s4_a_d4_breakdown import (
            _QTYPE_ORDER,
    ...
    def test_load_golden_rows_parses_caption_bool(self):
        ...
        from run_s4_a_d4_breakdown import load_golden_rows

        rows = load_golden_rows(self.golden_v2_path)
        # Phase 3 — cross_doc n=4→8 보강으로 162 row (caption_false +5)
        ...
        self.assertEqual(n_caption_true, 18)
        self.assertEqual(n_caption_false, 144)
...
class QtypeBreakdownTests(unittest.TestCase):
    ...
    def test_group_by_qtype_returns_all_9_keys(self):
        from run_s4_a_d4_breakdown import _QTYPE_ORDER, group_by_qtype
    ...
    def test_group_by_qtype_skips_unknown_qtype(self):
        ...
        from run_s4_a_d4_breakdown import group_by_qtype
...
class CaptionDependentSubsetTests(unittest.TestCase):
    ...
    def test_group_by_caption_true_false_split(self):
        from run_s4_a_d4_breakdown import group_by_caption
    ...
    def test_aggregate_caption_delta_correctness(self):
        ...
        from run_s4_a_d4_breakdown import _aggregate_group, group_by_caption
...
class PromptVersionHookTests(unittest.TestCase):
    ...
    def test_label_prompt_version_v1_majority(self):
        ...
        from run_s4_a_d4_breakdown import label_prompt_version
    ...
    def test_group_by_prompt_version_distributes_keys(self):
        ...
        from run_s4_a_d4_breakdown import group_by_prompt_version
...
class CaptionComposeStripTests(unittest.TestCase):
    ...
    def test_strip_both_table_and_figure_compose(self) -> None:
        ...
        from run_s4_a_d4_breakdown import _strip_caption_compose
...
class RerankWithBaseTextTests(unittest.TestCase):
    ...
    def test_rerank_caption_chunk_climbs_when_base_text_closer(self) -> None:
        ...
        """
        from run_s4_a_d4_breakdown import _rerank_with_base_text
...
class AggregationTests(unittest.TestCase):
    ...
    def test_aggregate_separates_eval_from_fail(self):
        ...
        from run_s4_a_d4_breakdown import _aggregate_group
