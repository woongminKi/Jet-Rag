...
| # | 파일 | 종류 | 변경 |
|---|---|---|---|
| 1 | `evals/run_s4_a_d4_compose_off.py` | 측정 도구 | `--no-vision-compose` CLI + option C 헬퍼 2건 + 측정 함수 시그니처 확장 |
| 2 | `api/tests/test_run_s4_a_d4_compose_off.py` | 단위 테스트 | `CaptionComposeStripTests` 5건 + `RerankWithBaseTextTests` 3건 |
...
```bash
cd api && uv run python ../evals/run_s4_a_d4_compose_off.py \
...
| 파일 | 경로 |
|---|---|
| 측정 도구 (수정) | `/Users/kiwoongmin/Desktop/documents/test-repo/image2/piLab/project/Jet-Rag/evals/run_s4_a_d4_compose_off.py` |
| 단위 테스트 (수정) | `/Users/kiwoongmin/Desktop/documents/test-repo/image2/piLab/project/Jet-Rag/api/tests/test_run_s4_a_d4_compose_off.py` |
