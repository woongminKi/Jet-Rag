...
## 10. 진단 결과 (다른 컴퓨터에서 채워넣기)

> reingest 후 본 섹션에 측정값을 paste. 본 문서를 진단 핸드오프 마스터로 유지.
...
- **S1** (job stage duration): (TBD)
- **S2** (최근 500건 median): (TBD)
- **S3** (retry_attempt 분포): (TBD)
- **S4** (vision_page_cache hit baseline): (TBD)

### 10.3 가설 검증 결과

- 가설 1 (vision 페이지 수 미반영): (TBD)
- 가설 2 (cold start fallback 부족): (TBD)
- 가설 3 (5분 TTL 진부화): (TBD)

### 10.4 1차 ship 진입 결정

- [ ] §3 진단 통과 기준 충족
- [ ] 사용자 결정 §8-1 (정확도 P0) + §8-5 (sample < 3 ETA 미노출) 답변 받음
- [ ] senior-developer 의뢰
